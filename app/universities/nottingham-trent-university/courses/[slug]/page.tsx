...
export async function generateStaticParams() {
  return (nottinghamtrentCourses as unknown as any[]).map((c: any) => ({ slug: c.slug }));
}
...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at Nottingham Trent University — Fees, IELTS & Intake for Indian Students 2026`,
