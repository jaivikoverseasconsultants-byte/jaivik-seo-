...
import { la_citeCourses } from '@/data/la-cite-courses';
...
export default function CoursesPage() {
  const courses = la_citeCourses as unknown as any[];
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `How many courses does La Cité College offer for international students?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `La Cité College offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at La Cité College?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at La Cité College is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the average tuition fee at La Cité College?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at La Cité College is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * 84 / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      },
      {
        '@type': 'Question',
        name: `What intake options does La Cité College offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `La Cité College offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to La Cité College?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to La Cité College in Canada through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `La Cité College — Courses for International Students`,
    description: `${courses.length} programs at La Cité College, Canada. Min IELTS ${_minIelts}+.`,
    ...
    itemListElement: courses.slice(0, 5).map((c: any, i: number) => ({
      ...
      item: {
        '@type': 'Course',
        name: c.name,
        provider: { '@type': 'CollegeOrUniversity', name: 'La Cité College' },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="la-cite-courses-index" defaultCountry="Canada" compact />
            </div>
          </div>
        </div>
      </section>
            ...
            <div key={level}>
              ...
              <div className="space-y-3">
                {(lvCourses as any[]).sort((a: any, b: any) => a.name.localeCompare(b.name)).map((c: any) => (
                  <Link key={c.slug} href={`/universities/la-cite-college/courses/${c.slug}`}
