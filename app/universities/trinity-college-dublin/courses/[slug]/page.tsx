...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at Trinity College Dublin — Fees in INR, IELTS & Requirements for Indian Students`,
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-3">{course.name} at Trinity College Dublin — Fees in INR, IELTS &amp; Requirements for Indian Students</h1>
