...
export function generateStaticParams() {
  return heriotWattUniversityDubaiCourses.map(c => ({ slug: c.slug }));
}
...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at Heriot-Watt University Dubai — Fees, IELTS & Intake for Indian Students 2026`,
    description: `${course.name} at Heriot-Watt University Dubai, ${(course as any).city || course.country} costs ₹${(course.annualINR / 100000).toFixed(1)}L/year for Indian students. IELTS ${course.ieltsMin}+, intakes ${course.intakeMonths.join(' & ')}. Apply with Jaivik Overseas — 13 years expertise, 99% visa success.`,
