...
import { ecolePolytechniqueCourses, getEcolePolytechniqueCourseBySlug } from '@/data/ecole-polytechnique-courses';
...
export async function generateStaticParams() {
  return (ecolePolytechniqueCourses as unknown as any[]).map((c: any) => ({ slug: c.slug }));
}
...
export default async function CourseDetailPage(
  ...
  const schema = {
    ...
    '@type': 'Course',
    name: course.name,
    provider: { '@type': 'CollegeOrUniversity', name: 'École Polytechnique', sameAs: 'https://www.polytechnique.edu' },
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4 flex-wrap">
            ...
            <Link href="/universities/ecole-polytechnique/courses" className="hover:text-white">Polytechnique</Link> /
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="ecole-polytechnique-${slug}" defaultCountry="France" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <CourseRichContent course={course as any} universityName="École Polytechnique" universitySlug="ecole-polytechnique" />
        ...
        <div>
          <div className="sticky top-20">
            <LeadForm source="ecole-polytechnique-detail-sidebar" defaultCountry="France" />
          </div>
        </div>
      </div>
    </>
