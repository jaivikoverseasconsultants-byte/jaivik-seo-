...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at Università Cattolica del Sacro Cuore 2026 – Fees, IELTS & Requirements`,
    description: `${course.name} at Università Cattolica del Sacro Cuore: ${course.duration}, €${course.annualEUR.toLocaleString()}/EUR/yr. IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas.`,
