...
export const metadata: Metadata = buildMetadata({
  title: 'Queen\'s International Courses â€“ All Programs, Fees & IELTS 2026',
  description: `Queen's University â€” ${(queensCourses as unknown as any[]).length} courses for international students. PGWP Eligible Â· IELTS 6.5+. September & January intakes. Free admission guidance from Jaivik Overseas Consultants.`,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              <div className="inline-flex items-center gap-2 bg-gold-500/20 text-gold-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
                ðŸ‡¨ðŸ‡¦ Kingston, Canada Â· PGWP Eligible Â· #209 QS
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                Queen's University â€” International Courses
              </h1>
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-3 text-sm">Quick Facts â€” Queen's</h3>
              {[
                ['Established', '1841'],
