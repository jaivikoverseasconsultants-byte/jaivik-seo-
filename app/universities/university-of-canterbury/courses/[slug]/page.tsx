...
import { uocCourses, getUocCourseBySlug } from '@/data/uoc-courses';
...
export async function generateStaticParams() {
  return (uocCourses as unknown as any[]).map((c: any) => ({ slug: c.slug }));
}
...
export default async function CoursePage(
  ...
  const schema = {
    ...
    name: course.name,
    provider: { '@type': 'CollegeOrUniversity', name: 'University of Canterbury', sameAs: 'https://www.canterbury.ac.nz' },
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4">
            ...
            <Link href="/universities/university-of-canterbury" className="hover:text-white">Canterbury</Link> /
            <Link href="/universities/university-of-canterbury/courses" className="hover:text-white">Courses</Link> /
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source={`uoc-course-${slug}`} defaultCountry="New Zealand" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <CourseRichContent course={course as any} universityName="University of Canterbury" universitySlug="university-of-canterbury" />
        ...
        <div className="space-y-5">
          <div className="sticky top-20">
            <LeadForm source={`uoc-course-${slug}-sidebar`} defaultCountry="New Zealand" />
            <div className="mt-4 bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <Link href="/universities/university-of-canterbury/courses" className="block text-sm text-brand-700 hover:underline">All Canterbury Courses →</Link>
