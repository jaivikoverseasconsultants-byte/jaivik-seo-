...
import { jcu_brisbaneCourses } from '@/data/jcu-brisbane-courses';
import LeadForm from '@/components/LeadForm';
import JsonLd from '@/components/JsonLd';

export const metadata: Metadata = buildMetadata({
  title: 'JCU Brisbane International Courses – All Programs, Fees & IELTS 2026',
  description: `James Cook University Brisbane — ${(jcu_brisbaneCourses as unknown as any[]).length} courses for international students. IELTS 6+. February & July intakes. Free admission guidance from Jaivik Overseas Consultants.`,
  path: '/universities/jcu-brisbane/courses',
  keywords: ['JCU Brisbane courses', 'James Cook University Brisbane international', 'JCU Brisbane fees', 'study in Australia'],
});
...
export default function CoursesPage() {
  const courses = jcu_brisbaneCourses as unknown as any[];
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `How many courses does James Cook University Brisbane offer for international students?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `James Cook University Brisbane offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at James Cook University Brisbane?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at James Cook University Brisbane is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the average tuition fee at James Cook University Brisbane?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at James Cook University Brisbane is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * 84 / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      },
      {
        '@type': 'Question',
        name: `What intake options does James Cook University Brisbane offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `James Cook University Brisbane offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to James Cook University Brisbane?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to James Cook University Brisbane in Australia through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `James Cook University Brisbane — Courses for International Students`,
    description: `${courses.length} programs at James Cook University Brisbane, Australia. Min IELTS ${_minIelts}+.`,
  ...
  const schema = {
    ...
    address: { '@type': 'PostalAddress', addressLocality: 'Brisbane', addressRegion: 'Queensland', addressCountry: 'AU' },
  };
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4">
            ...
            <span className="text-white">JCU Brisbane</span>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              <div className="inline-flex items-center gap-2 bg-gold-500/20 text-gold-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
                🇦🇺 Brisbane, Australia · #401 QS World Ranking
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                James Cook University Brisbane — International Courses
              </h1>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {[
                  ...
                  { label: 'Campus', value: 'Brisbane Campus' },
                ].map(s => (
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-3 text-sm">Quick Facts — JCU Brisbane</h3>
              {[
                ['Established', '1970'],
