...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at Massey University — Fees, IELTS & Intake for Indian Students 2026`,
...
export default async function CoursePage(
  ...
  const schema = {
    ...
    name: course.name,
    provider: { '@type': 'CollegeOrUniversity', name: 'Massey University', sameAs: 'https://www.massey.ac.nz' },
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4">
            ...
            <Link href="/universities/massey-university/courses" className="hover:text-white">Courses</Link> /
          ...
          <div className="sticky top-20">
            ...
            <div className="mt-4 bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <Link href="/universities/massey-university/courses" className="block text-sm text-brand-700 hover:underline">All Massey Courses →</Link>
