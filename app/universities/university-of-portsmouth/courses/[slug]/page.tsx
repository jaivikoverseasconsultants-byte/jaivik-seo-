...
export async function generateStaticParams() {
  return (portsmouthCourses as unknown as any[]).map((c: any) => ({ slug: c.slug }));
}
...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at University of Portsmouth — Fees, IELTS & Intake for Indian Students 2026`,
