...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${c.name} at Curtin Singapore 2026 – Fees, IELTS & Requirements`,
    description: `${c.name} at Curtin Singapore: ${c.duration}, S$${(c.annualSGD/1000).toFixed(0)}K SGD/yr. IELTS ${c.ieltsMin}+. Apply via Jaivik Overseas Consultants.`,
