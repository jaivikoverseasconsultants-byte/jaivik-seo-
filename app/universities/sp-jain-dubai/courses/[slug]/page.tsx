...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at S P Jain School of Global Management 2026 – Fees, IELTS & Requirements`,
    description: `${course.name} at S P Jain School of Global Management: ${course.duration}, AED ${course.annualAED.toLocaleString()}/AED/yr. IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas.`,
