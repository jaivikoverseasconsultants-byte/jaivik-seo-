...
const UNIVERSITY_SLUG = 'university-of-east-london';

export const metadata: Metadata = buildMetadata({
  title: 'University of East London Courses — Fees & IELTS 2026',
  description: `University of East London — ${(uelCourses as unknown as any[]).length} courses for international students. IELTS 5.5+. September & January intakes. Free admission guidance from Jaivik Overseas Consultants.`,
  path: '/universities/university-of-east-london/courses',
  keywords: ['UEL courses', 'University of East London international', 'UEL fees', 'study in UK', 'UK university'],
});
...
export default function CoursesPage() {
  const courses = uelCourses as unknown as any[];
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `How many courses does University of East London offer for international students?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `University of East London offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at University of East London?`,
        acceptedAnswer: {
          '@type': 'Answer',
      ...
      ...(_avgFeeUSD > 0 ? [{
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at University of East London is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * RATE_TO_INR.USD / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      }] : []),
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `University of East London offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to University of East London?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to University of East London in United Kingdom through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `University of East London — Courses for International Students`,
    description: `${courses.length} programs at University of East London, United Kingdom. Min IELTS ${_minIelts}+.`,
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4">
            ...
            <span className="text-white">UEL</span>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="uel-courses-index" defaultCountry="UK" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div key={level}>
              ...
              <div className="space-y-3">
                {(lvCourses as any[]).sort((a: any, b: any) => a.name.localeCompare(b.name)).map((c: any) => (
                  <Link key={c.slug} href={`/universities/university-of-east-london/courses/${c.slug}`}
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            <LeadForm source="uel-courses-sidebar" defaultCountry="UK" />
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-3 text-sm">Quick Facts — UEL</h3>
              {[
                ['Established', '1898'],
