  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      ...(_avgFeeUSD > 0 ? [{
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at Royal Holloway, University of London is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * RATE_TO_INR.USD / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      }] : []),
      {
        '@type': 'Question',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                Royal Holloway, University of London — International Courses
              </h1>
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-3 text-sm">Quick Facts — Royal Holloway</h3>
              {[
                ['Established', '1849'],
