...
export function generateStaticParams() {
  return universityOfCopenhagenCourses.map(c => ({ slug: c.slug }));
}
...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at University of Copenhagen 2026 – Fees, IELTS & Requirements`,
    description: `${course.name} at University of Copenhagen: ${course.duration}, DKK ${course.annualDKK.toLocaleString()}/DKK/yr. IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas.`,
