...
export default function NtuCoursesPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `How many courses does Nanyang Technological University offer for international students?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Nanyang Technological University offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at Nanyang Technological University?`,
        acceptedAnswer: {
          '@type': 'Answer',
      ...
      ...(_avgFeeUSD > 0 ? [{
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at Nanyang Technological University is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * 84 / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      }] : []),
      {
        '@type': 'Question',
        name: `What intake options does Nanyang Technological University offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Nanyang Technological University offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to Nanyang Technological University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to Nanyang Technological University in Singapore through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `Nanyang Technological University — Courses for International Students`,
    description: `${courses.length} programs at Nanyang Technological University, Singapore. Min IELTS ${_minIelts}+.`,
  ...
  return (
    <>
      ...
      <div className="flex items-center gap-2 text-xs text-gray-500 mb-6">
        ...
        <Link href="/universities/nanyang-technological-university" className="hover:text-brand-700">Nanyang Technological University</Link> /
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 space-y-3">
          {courses.map(c => (
            <Link key={c.id} href={`/universities/nanyang-technological-university/courses/${c.slug}`}
