...
export async function generateMetadata(
  ...
  return buildMetadata({
    ...
    description: `${c.name} at Nanyang Technological University, ${(c as any).city || c.country}${feeSentenceINR(c as any, c.annualINR)}${hasPublishedIelts(UNIVERSITY_SLUG, c as never) ? ` IELTS ${c.ieltsMin}+` : ''}, intakes ${c.intakeMonths.join(' & ')}. Apply with Jaivik Overseas — 13 years expertise, 99% visa success.`,
