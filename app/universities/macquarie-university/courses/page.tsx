...
export const metadata: Metadata = buildMetadata({
  title: 'Macquarie University International Courses – All Programs, Fees & IELTS 2026',
  description: `Macquarie University — ${(macqCourses as unknown as any[]).length} courses for international students. IELTS 6.5+. February & July intakes. Free admission guidance from Jaivik Overseas Consultants.`,
...
export default function CoursesPage() {
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Macquarie University offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at Macquarie University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at Macquarie University is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the average tuition fee at Macquarie University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at Macquarie University is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * 84 / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      },
      {
        '@type': 'Question',
        name: `What intake options does Macquarie University offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Macquarie University offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to Macquarie University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to Macquarie University in Australia through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    ...
    description: `${courses.length} programs at Macquarie University, Australia. Min IELTS ${_minIelts}+.`,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              <div className="inline-flex items-center gap-2 bg-gold-500/20 text-gold-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
                🇦🇺 Sydney, Australia · #195 QS World Ranking
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                Macquarie University — International Courses
              </h1>
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-3 text-sm">Quick Facts — Macquarie</h3>
              {[
                ['Established', '1964'],
