...
export default function CoursesPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `How many courses does TU Munich offer for international students?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `TU Munich offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at TU Munich?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at TU Munich is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      ...(_avgFeeUSD > 0 ? [{
        '@type': 'Question',
        name: `What is the average tuition fee at TU Munich?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at TU Munich is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * RATE_TO_INR.USD / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      }] : []),
      {
        '@type': 'Question',
        name: `What intake options does TU Munich offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `TU Munich offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to TU Munich?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to TU Munich in Germany through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `TU Munich — Courses for International Students`,
    description: `${courses.length} programs at TU Munich, Germany. Min IELTS ${_minIelts}+.`,
    ...
    itemListElement: courses.slice(0, 5).map((c: any, i: number) => ({
      ...
      item: {
        '@type': 'Course',
        name: c.name,
        provider: { '@type': 'CollegeOrUniversity', name: 'TU Munich' },
