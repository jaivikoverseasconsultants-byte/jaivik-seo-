...
import { uppsalaUniversityCourses } from '@/data/uppsala-university-courses';
...
export default function CoursesPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `How many courses does Uppsala University offer for international students?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Uppsala University offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at Uppsala University?`,
        acceptedAnswer: {
          '@type': 'Answer',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at Uppsala University is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * 84 / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      },
      {
        '@type': 'Question',
        name: `What intake options does Uppsala University offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Uppsala University offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to Uppsala University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to Uppsala University in Sweden through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `Uppsala University — Courses for International Students`,
    description: `${courses.length} programs at Uppsala University, Sweden. Min IELTS ${_minIelts}+.`,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              <div className="inline-flex items-center gap-2 bg-gold-500/20 text-gold-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
                🇸🇪 Uppsala, Sweden · #120 QS World Ranking
              </div>
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="uppsala-university-courses" defaultCountry="Sweden" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div key={level}>
              ...
              <div className="space-y-3">
                {(lvCourses as any[]).sort((a: any, b: any) => a.name.localeCompare(b.name)).map((c: any) => (
                  <Link key={c.slug} href={`/universities/uppsala-university/courses/${c.slug}`}
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            <LeadForm source="uppsala-university-sidebar" defaultCountry="Sweden" />
