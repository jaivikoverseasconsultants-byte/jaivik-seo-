...
import { dcuCourses, getDcuCourseBySlug } from '@/data/dcu-courses';
    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <CourseRichContent course={course as any} universityName="Dublin City University" universitySlug="dublin-city-university" />
