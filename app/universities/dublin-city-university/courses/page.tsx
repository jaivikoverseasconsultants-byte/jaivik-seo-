...
export const metadata: Metadata = buildMetadata({
  title: 'Dublin City University International Courses â€“ All Programs, Fees & IELTS 2026',
  description: `Dublin City University â€” ${(dcuCourses as unknown as any[]).length} courses for international students. IELTS 6+. September intakes. Free admission guidance from Jaivik Overseas Consultants.`,
  path: '/universities/dublin-city-university/courses',
  keywords: ['DCU courses', 'Dublin City University international', 'DCU fees', 'study in Ireland', 'Ireland university'],
});
...
export default function CoursesPage() {
  ...
  const schema = {
    ...
    name: 'Dublin City University', sameAs: 'https://www.dcu.ie',
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4">
            ...
            <span className="text-white">DCU</span>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                Dublin City University â€” International Courses
              </h1>
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="dcu-courses-index" defaultCountry="Ireland" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div key={level}>
              ...
              <div className="space-y-3">
                {(lvCourses as any[]).sort((a: any, b: any) => a.name.localeCompare(b.name)).map((c: any) => (
                  <Link key={c.slug} href={`/universities/dublin-city-university/courses/${c.slug}`}
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            <LeadForm source="dcu-courses-sidebar" defaultCountry="Ireland" />
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-3 text-sm">Quick Facts â€” DCU</h3>
              {[
                ['Established', '1989'],
