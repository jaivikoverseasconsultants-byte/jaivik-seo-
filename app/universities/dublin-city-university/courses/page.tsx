...
import { dcuCourses } from '@/data/dcu-courses';
...
export default function CoursesPage() {
  const courses = dcuCourses as unknown as any[];
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `How many courses does Dublin City University offer for international students?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Dublin City University offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at Dublin City University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at Dublin City University is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      ...(_avgFeeUSD > 0 ? [{
        '@type': 'Question',
      ...
      {
        '@type': 'Question',
        name: `What intake options does Dublin City University offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Dublin City University offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to Dublin City University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to Dublin City University in Ireland through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `Dublin City University — Courses for International Students`,
    description: `${courses.length} programs at Dublin City University, Ireland. Min IELTS ${_minIelts}+.`,
    ...
    itemListElement: courses.slice(0, 5).map((c: any, i: number) => ({
      ...
      item: {
        '@type': 'Course',
        name: c.name,
        provider: { '@type': 'CollegeOrUniversity', name: 'Dublin City University' },
  ...
  const schema = {
    ...
    name: 'Dublin City University', sameAs: 'https://www.dcu.ie', url: 'https://www.dcu.ie',
  };
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-3">Dublin City University</h1>
          <p className="text-blue-100 text-lg mb-6">{totalCourses} Programs · Dublin, Ireland · IELTS 6.0–7.0+</p>
          ...
          <div key={level} className="mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {levelCourses.map((course: any) => {
                ...
                return (
                  <Link key={course.id} href={`/universities/dublin-city-university/courses/${course.slug}`}
