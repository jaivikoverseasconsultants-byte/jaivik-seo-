...
export async function generateStaticParams() {
  return (sunderlandCourses as unknown as any[]).map((c: any) => ({ slug: c.slug }));
}
...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at University of Sunderland — Fees, IELTS & Intake for Indian Students 2026`,
