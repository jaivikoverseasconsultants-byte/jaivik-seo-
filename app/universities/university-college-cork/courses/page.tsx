...
export const metadata: Metadata = buildMetadata({
  title: 'University College Cork International Courses â€“ All Programs, Fees & IELTS 2026',
  description: `University College Cork â€” ${(uccCourses as unknown as any[]).length} courses for international students. IELTS 6.5+. September intakes. Free admission guidance from Jaivik Overseas Consultants.`,
  path: '/universities/university-college-cork/courses',
  keywords: ['UCC courses', 'University College Cork international', 'UCC fees', 'study in Ireland', 'Ireland university'],
});
...
export default function CoursesPage() {
  ...
  const schema = {
    ...
    name: 'University College Cork', sameAs: 'https://www.ucc.ie',
    address: { '@type': 'PostalAddress', addressLocality: 'Cork', addressRegion: 'Munster', addressCountry: 'IE' },
  };
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4">
            ...
            <span className="text-white">UCC</span>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              <div className="inline-flex items-center gap-2 bg-gold-500/20 text-gold-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
                ðŸ‡®ðŸ‡ª Cork, Ireland Â· #303 QS World Ranking
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                University College Cork â€” International Courses
              </h1>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {[
                  ...
                  { label: 'QS Ranking', value: '#303 QS' },
                  { label: 'Avg PG Fee', value: `â‚¬${Math.round(avgFee/1000)}K` },
                  { label: 'Campus', value: 'Cork' },
                ].map(s => (
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="ucc-courses-index" defaultCountry="Ireland" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div key={level}>
              ...
              <div className="space-y-3">
                {(lvCourses as any[]).sort((a: any, b: any) => a.name.localeCompare(b.name)).map((c: any) => (
                  <Link key={c.slug} href={`/universities/university-college-cork/courses/${c.slug}`}
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            <LeadForm source="ucc-courses-sidebar" defaultCountry="Ireland" />
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-3 text-sm">Quick Facts â€” UCC</h3>
              {[
                ['Established', '1845'],
