...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return buildMetadata({
    title: `${course.name} | UCC – Fees, IELTS & Intake 2026`,
    description: `${course.name} at University College Cork. Annual fee €${fee.toLocaleString()}. IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas Consultants.`,
