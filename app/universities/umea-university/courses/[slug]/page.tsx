...
export async function generateMetadata(
  ...
  return buildMetadata({
    ...
    description: `${course.name} at Umeå University: ${course.duration}, SEK ${course.annualSEK.toLocaleString()}/SEK/yr. IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas.`,
