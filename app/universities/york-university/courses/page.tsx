...
import { yorkCourses } from '@/data/york-courses';
import LeadForm from '@/components/LeadForm';
import JsonLd from '@/components/JsonLd';

export const metadata: Metadata = buildMetadata({
  title: 'York International Courses – All Programs, Fees & IELTS 2026',
  description: `York University — ${(yorkCourses as unknown as any[]).length} courses for international students. PGWP Eligible · IELTS 6.5+. September & January intakes. Free admission guidance from Jaivik Overseas Consultants.`,
  path: '/universities/york-university/courses',
  keywords: ['York courses', 'York University international', 'York fees', 'study in Canada', 'Canada university', 'PGWP'],
});
...
export default function CoursesPage() {
  const courses = yorkCourses as unknown as any[];
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `How many courses does York University offer for international students?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `York University offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at York University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at York University is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the average tuition fee at York University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at York University is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * 84 / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      },
      {
        '@type': 'Question',
        name: `What intake options does York University offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `York University offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to York University in Canada through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    ...
    description: `${courses.length} programs at York University, Canada. Min IELTS ${_minIelts}+.`,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              <div className="inline-flex items-center gap-2 bg-gold-500/20 text-gold-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
                🇨🇦 Toronto, Canada · PGWP Eligible · #401 QS
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                York University — International Courses
              </h1>
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="york-courses-index" defaultCountry="Canada" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            <LeadForm source="york-courses-sidebar" defaultCountry="Canada" />
