...
export const metadata: Metadata = buildMetadata({
  title: 'York International Courses â€“ All Programs, Fees & IELTS 2026',
  description: `York University â€” ${(yorkCourses as unknown as any[]).length} courses for international students. PGWP Eligible Â· IELTS 6.5+. September & January intakes. Free admission guidance from Jaivik Overseas Consultants.`,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              <div className="inline-flex items-center gap-2 bg-gold-500/20 text-gold-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
                ðŸ‡¨ðŸ‡¦ Toronto, Canada Â· PGWP Eligible Â· #401 QS
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                York University â€” International Courses
              </h1>
