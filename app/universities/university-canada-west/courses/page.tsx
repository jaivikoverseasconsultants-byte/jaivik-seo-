...
export const metadata: Metadata = buildMetadata({
  title: 'UCW International Courses – All Programs, Fees & IELTS 2026',
  description: `University Canada West — ${(ucwCourses as unknown as any[]).length} courses for international students. PGWP Eligible · IELTS 6+. September & January & May intakes. Free admission guidance from Jaivik Overseas Consultants.`,
...
export default function CoursesPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `How many courses does University Canada West offer for international students?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `University Canada West offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at University Canada West?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at University Canada West is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the average tuition fee at University Canada West?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at University Canada West is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * 84 / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      },
      {
        '@type': 'Question',
        name: `What intake options does University Canada West offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `University Canada West offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to University Canada West?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to University Canada West in Canada through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `University Canada West — Courses for International Students`,
    description: `${courses.length} programs at University Canada West, Canada. Min IELTS ${_minIelts}+.`,
    ...
    itemListElement: courses.slice(0, 5).map((c: any, i: number) => ({
      ...
      item: {
        '@type': 'Course',
        name: c.name,
        provider: { '@type': 'CollegeOrUniversity', name: 'University Canada West' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                University Canada West — International Courses
              </h1>
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-3 text-sm">Quick Facts — UCW</h3>
              {[
                ['Established', '2004'],
