...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at UAE University 2026 – Fees, IELTS & Requirements`,
    description: `${course.name} at UAE University: ${course.duration}, $${course.annualUSD.toLocaleString()}/USD/yr. IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas.`,
