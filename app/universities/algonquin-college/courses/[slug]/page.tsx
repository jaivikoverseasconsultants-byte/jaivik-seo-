...
import { algonquinRealCourses, getAlgonquinRealCourseBySlug } from '@/data/algonquin-courses';
...
const PUBLISHED_TESTS = {"ielts":true,"toefl":true,"pte":false};
...
const UNIVERSITY_SLUG = 'algonquin-college';

function courseParams() {
  return (algonquinRealCourses as unknown as any[]).map((c) => ({ slug: c.slug }));
}

async function courseMetadata(slug: string): Promise<Metadata> {
  const course = getAlgonquinRealCourseBySlug(slug) as any;
  if (!course) return {};
  const english = englishTests(course).some((t) => t.label === 'IELTS Academic') ? ` IELTS ${course.ieltsMin}+.` : '';
  return buildMetadata({
    title: `${course.name} at Algonquin College`,
    description: `${course.name} at Algonquin College, Ottawa${feeSentenceINR(course, course.annualINR)}${english} Apply with Jaivik Overseas — 13 years expertise, 99% visa success.`,
    path: `/universities/algonquin-college/courses/${slug}`,
    keywords: [course.name, 'Algonquin', 'Algonquin College', 'study in Canada', course.level],
  });
}
...
async function CourseView({ slug }: { slug: string }) {
  ...
  const schema = {
    ...
    '@type': 'Course',
    name: course.name,
    provider: { '@type': 'CollegeOrUniversity', name: 'Algonquin College', sameAs: 'https://www.algonquincollege.com' },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3">{course.name} at Algonquin College — {titleFeeFragment(course, course.annualINR)}Requirements for Indian Students</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
            ...
            {englishTests(course).length > 0 ? (
              ...
              <p className="text-sm text-gray-600">
                Algonquin College doesn’t publish a single English score that applies to this programme.
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
            ...
            <p className="text-sm text-gray-700">College programmes qualify for a PGWP only if the programme is in an eligible field of study (IRCC rule since November 2024). We confirm eligibility for this specific programme during counselling.</p>
          </div>

          <CourseRichContent course={course} universityName="Algonquin College" universitySlug="algonquin-college" />
          ...
          <div className="sticky top-20">
            ...
            <div className="mt-4 bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <Link href="/universities/algonquin-college/courses" className="block text-sm text-brand-700 hover:underline">All Algonquin Courses →</Link>
