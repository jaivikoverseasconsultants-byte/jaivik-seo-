...
import { ritDubaiCourses, getRitDubaiCourseBySlug } from '@/data/rit-dubai-courses';
...
export async function generateStaticParams() {
  return (ritDubaiCourses as unknown as any[]).map((c: any) => ({ slug: c.slug }));
}
...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at Rochester Institute of Technology Dubai — Fees in INR, IELTS & Requirements for Indian Students`,
...
export default async function CourseDetailPage(
  ...
  const schema = {
    ...
    '@type': 'Course',
    name: course.name,
    provider: { '@type': 'CollegeOrUniversity', name: 'Rochester Institute of Technology Dubai', sameAs: 'https://www.rit.edu/dubai' },
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4 flex-wrap">
            ...
            <Link href="/universities/rit-dubai/courses" className="hover:text-white">RIT Dubai</Link> /
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3">{course.name} at Rochester Institute of Technology Dubai — Fees in INR, IELTS &amp; Requirements for Indian Students</h1>
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="rit-dubai-${slug}" defaultCountry="UAE" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <CourseRichContent course={course as any} universityName="Rochester Institute of Technology Dubai" universitySlug="rit-dubai" />
        ...
        <div>
          <div className="sticky top-20">
            <LeadForm source="rit-dubai-detail-sidebar" defaultCountry="UAE" />
          </div>
        </div>
      </div>
    </>
