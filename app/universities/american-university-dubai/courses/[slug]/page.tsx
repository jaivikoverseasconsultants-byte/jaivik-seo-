...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at American University in Dubai 2026 – Fees, IELTS & Requirements`,
    description: `${course.name} at American University in Dubai: ${course.duration}, AED ${course.annualAED.toLocaleString()}/AED/yr. IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas.`,
