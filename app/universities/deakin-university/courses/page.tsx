...
import { deakinCourses } from '@/data/deakin-courses';
import LeadForm from '@/components/LeadForm';
import JsonLd from '@/components/JsonLd';

export const metadata: Metadata = buildMetadata({
  title: 'Deakin University International Courses – All Programs, Fees & IELTS 2026',
  description: `Deakin University — ${(deakinCourses as unknown as any[]).length} courses for international students. IELTS 6+. February & July intakes. Free admission guidance from Jaivik Overseas Consultants.`,
  path: '/universities/deakin-university/courses',
  keywords: ['Deakin courses', 'Deakin University international', 'Deakin fees', 'study in Australia', 'Australia university'],
});
...
export default function CoursesPage() {
  const courses = deakinCourses as unknown as any[];
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Deakin University offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at Deakin University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at Deakin University is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the average tuition fee at Deakin University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at Deakin University is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * 84 / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      },
      {
        '@type': 'Question',
        name: `What intake options does Deakin University offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Deakin University offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to Deakin University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to Deakin University in Australia through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    ...
    description: `${courses.length} programs at Deakin University, Australia. Min IELTS ${_minIelts}+.`,
  ...
  const schema = {
    ...
    name: 'Deakin University', sameAs: 'https://www.deakin.edu.au',
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4">
            ...
            <span className="text-white">Deakin</span>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              <div className="inline-flex items-center gap-2 bg-gold-500/20 text-gold-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
                🇦🇺 Melbourne, Australia · #301 QS World Ranking
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                Deakin University — International Courses
              </h1>
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="deakin-courses-index" defaultCountry="Australia" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            <LeadForm source="deakin-courses-sidebar" defaultCountry="Australia" />
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-3 text-sm">Quick Facts — Deakin</h3>
              {[
                ['Established', '1974'],
