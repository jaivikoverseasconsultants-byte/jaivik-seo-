...
export async function generateStaticParams() {
  return (westlondonCourses as unknown as any[]).map((c: any) => ({ slug: c.slug }));
}
...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at University of West London — Fees, IELTS & Intake for Indian Students 2026`,
