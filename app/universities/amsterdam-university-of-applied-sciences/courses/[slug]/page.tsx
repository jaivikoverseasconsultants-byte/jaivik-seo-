...
export async function generateStaticParams() {
  return (amsterdamUniversityOfAppliedSciencesCourses as unknown as any[]).map((c: any) => ({ slug: c.slug }));
}
...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at Amsterdam University of Applied Sciences — Fees, IELTS & Intake for Indian Students 2026`,
