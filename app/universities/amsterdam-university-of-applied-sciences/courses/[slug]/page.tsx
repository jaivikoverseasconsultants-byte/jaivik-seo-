...
import { amsterdamUniversityOfAppliedSciencesCourses, getAmsterdamUniversityOfAppliedSciencesCourseBySlug } from '@/data/amsterdam-university-of-applied-sciences-courses';
...
export function generateStaticParams() {
  return amsterdamUniversityOfAppliedSciencesCourses.map(c => ({ slug: c.slug }));
}
...
export async function generateMetadata(
  ...
  const course = getAmsterdamUniversityOfAppliedSciencesCourseBySlug(slug);
  if (!course) return {};
  return buildMetadata({
    title: `${course.name} at Amsterdam University of Applied Sciences 2026 – Fees, IELTS & Requirements`,
    description: `${course.name} at Amsterdam University of Applied Sciences: ${course.duration}, €${course.annualEUR.toLocaleString()}/EUR/yr. IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas.`,
...
export default async function CourseDetailPage(
  ...
  const schema = {
    ...
    '@type': 'Course',
    name: course.name,
    provider: { '@type': 'CollegeOrUniversity', name: 'Amsterdam University of Applied Sciences', sameAs: 'https://www.hva.nl' },
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4 flex-wrap">
            ...
            <Link href="/universities/amsterdam-university-of-applied-sciences/courses" className="hover:text-white">AUAS</Link> /
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="amsterdam-university-of-applied-sciences-${slug}" defaultCountry="Netherlands" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <CourseRichContent course={course as any} universityName="Amsterdam University of Applied Sciences" universitySlug="amsterdam-university-of-applied-sciences" />
        ...
        <div>
          <div className="sticky top-20">
            <LeadForm source="amsterdam-university-of-applied-sciences-detail-sidebar" defaultCountry="Netherlands" />
          </div>
        </div>
      </div>
    </>
