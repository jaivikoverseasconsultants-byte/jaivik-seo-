...
import { scuCourses } from '@/data/scu-courses';
import LeadForm from '@/components/LeadForm';
import JsonLd from '@/components/JsonLd';

export const metadata: Metadata = buildMetadata({
  title: 'Southern Cross University International Courses – All Programs, Fees & IELTS 2026',
  description: `Southern Cross University — ${(scuCourses as unknown as any[]).length} courses for international students. IELTS 6+. February & July intakes. Free admission guidance from Jaivik Overseas Consultants.`,
  path: '/universities/southern-cross-university/courses',
  keywords: ['SCU courses', 'Southern Cross University international', 'SCU fees', 'study in Australia', 'Australia university'],
});
...
export default function CoursesPage() {
  const courses = scuCourses as unknown as any[];
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Southern Cross University offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at Southern Cross University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at Southern Cross University is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the average tuition fee at Southern Cross University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at Southern Cross University is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * 84 / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      },
      {
        '@type': 'Question',
        name: `What intake options does Southern Cross University offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Southern Cross University offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to Southern Cross University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to Southern Cross University in Australia through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    ...
    description: `${courses.length} programs at Southern Cross University, Australia. Min IELTS ${_minIelts}+.`,
  ...
  const schema = {
    ...
    name: 'Southern Cross University', sameAs: 'https://www.scu.edu.au',
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4">
            ...
            <span className="text-white">SCU</span>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                Southern Cross University — International Courses
              </h1>
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-3 text-sm">Quick Facts — SCU</h3>
              {[
                ['Established', '1994'],
