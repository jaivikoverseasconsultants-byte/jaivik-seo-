...
export const metadata: Metadata = buildMetadata({
  title: 'Karlsruhe Institute of Technology International Courses â€“ Programs, Fees & IELTS 2026',
  description: `Karlsruhe Institute of Technology â€” ${(kitCourses as unknown as any[]).length} courses for international students. IELTS 6.5+. October & April intakes. Free admission guidance from Jaivik Overseas Consultants.`,
  path: '/universities/karlsruhe-institute-of-technology/courses',
  keywords: ['KIT courses', 'Karlsruhe Institute of Technology international', 'study in Germany', 'Germany university'],
});
...
export default function CoursesPage() {
  ...
  const schema = {
    ...
    name: 'Karlsruhe Institute of Technology', sameAs: 'https://www.kit.edu/english/',
    address: { '@type': 'PostalAddress', addressLocality: 'Karlsruhe', addressRegion: 'Baden-WÃ¼rttemberg', addressCountry: 'DE' },
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              <div className="inline-flex items-center gap-2 bg-gold-500/20 text-gold-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
                ðŸ‡©ðŸ‡ª Karlsruhe, Germany Â· #119 QS World Ranking
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                Karlsruhe Institute of Technology â€” International Courses
              </h1>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {[
                  ...
                  { label: 'QS Ranking', value: '#119 QS' },
                  { label: 'Avg PG Fee', value: `â‚¬${Math.round(avgFee/1000)}K` },
                  { label: 'Campus', value: 'Karlsruhe' },
                ].map(s => (
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="kit-courses-index" defaultCountry="Germany" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div key={level}>
              ...
              <div className="space-y-3">
                {(lvC as any[]).sort((a: any, b: any) => a.name.localeCompare(b.name)).map((c: any) => (
                  <Link key={c.slug} href={`/universities/karlsruhe-institute-of-technology/courses/${c.slug}`}
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            <LeadForm source="kit-courses-sidebar" defaultCountry="Germany" />
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-3 text-sm">Quick Facts â€” KIT</h3>
              {[
                ['Established', '1825'],
