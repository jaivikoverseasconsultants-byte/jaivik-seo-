...
export const metadata: Metadata = buildMetadata({
  title: 'Singapore Management University Courses & Programs 2026 – Fees, IELTS & Intakes',
  description: '50 programs at Singapore Management University for Indian students. Tuition, IELTS requirements, intake dates. Free counselling by Jaivik Overseas.',
  path: '/universities/singapore-management-university/courses',
});

const levels = ['All', 'Bachelor', 'Master', 'Doctoral', 'Diploma'];

export default function SmuCoursesPage() {
  const courses = smuCourses;
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Singapore Management University — All Courses & Programs 2026</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 space-y-3">
          {courses.map(c => (
            <Link key={c.id} href={`/universities/singapore-management-university/courses/${c.slug}`}
