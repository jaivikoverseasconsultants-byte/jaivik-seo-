...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at University of Gothenburg 2026 – Fees, IELTS & Requirements`,
    description: `${course.name} at University of Gothenburg: ${course.duration}, $${course.annualUSD.toLocaleString()}/yr. IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas.`,
