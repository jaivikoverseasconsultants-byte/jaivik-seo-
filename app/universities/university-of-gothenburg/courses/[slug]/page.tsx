...
export async function generateMetadata(
  ...
  return buildMetadata({
    ...
    description: `${course.name} at University of Gothenburg: ${course.duration}, SEK ${course.annualSEK.toLocaleString()}/SEK/yr. IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas.`,
