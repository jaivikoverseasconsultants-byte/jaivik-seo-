...
export default async function CoursePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const schema = { '@context': 'https://schema.org', '@type': 'Course', name: course.name, provider: { '@type': 'CollegeOrUniversity', name: 'Free University of Berlin', sameAs: 'https://www.fu-berlin.de' }, courseMode: 'full-time', educationalLevel: course.studyLevel };
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-blue-100 text-lg">Free University of Berlin · Berlin, Germany · {course.duration}</p>
        </div>
      </section>
      <section className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <CourseRichContent course={course as any} universityName="Free University of Berlin" universitySlug="free-university-berlin" />
          <div className="bg-brand-700 text-white rounded-2xl p-6">
            ...
            <Link href="/universities/free-university-berlin/courses" className="flex items-center gap-2 text-brand-700 hover:text-brand-900 font-medium text-sm">← All FU Berlin Courses</Link>
          </div>
        </div>
      </section>
