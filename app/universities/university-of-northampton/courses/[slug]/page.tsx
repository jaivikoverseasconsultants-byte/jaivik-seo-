...
export function generateStaticParams() {
  return northamptonCourses.map(c => ({ slug: c.slug }));
}
...
export default async function CoursePage(
  ...
  const schema = {
    ...
    name: course.name,
    provider: { '@type': 'CollegeOrUniversity', name: 'University of Northampton', sameAs: 'https://www.northampton.ac.uk' },
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4">
            ...
            <Link href="/universities/university-of-northampton/courses" className="hover:text-white">Northampton</Link> /
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source={`university-of-northampton-${slug}`} defaultCountry="United Kingdom" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <CourseRichContent course={course as any} universityName="University of Northampton" universitySlug="university-of-northampton" />
        ...
        <div className="space-y-5">
          <div className="sticky top-20">
            <LeadForm source={`university-of-northampton-${slug}-sidebar`} defaultCountry="United Kingdom" />
            <div className="mt-4 bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <Link href="/universities/university-of-northampton/courses" className="block text-sm text-brand-700 hover:underline">All Northampton Courses →</Link>
