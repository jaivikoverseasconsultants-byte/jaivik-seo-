...
import { vrijeUniversiteitAmsterdamCourses, getVrijeUniversiteitAmsterdamCourseBySlug } from '@/data/vrije-universiteit-amsterdam-courses';
...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at Vrije Universiteit Amsterdam — Fees in INR, IELTS & Requirements for Indian Students`,
    description: `${course.name} at Vrije Universiteit Amsterdam, ${(course as any).city || course.country} costs ₹${(course.annualINR / 100000).toFixed(1)}L/year for Indian students. IELTS ${course.ieltsMin}+, intakes ${course.intakeMonths.join(' & ')}. Apply with Jaivik Overseas — 13 years expertise, 99% visa success.`,
...
export default async function CourseDetailPage(
  ...
  const schema = {
    ...
    '@type': 'Course',
    name: course.name,
    provider: { '@type': 'CollegeOrUniversity', name: 'Vrije Universiteit Amsterdam', sameAs: 'https://www.vu.nl' },
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4 flex-wrap">
            ...
            <Link href="/universities/vrije-universiteit-amsterdam/courses" className="hover:text-white">VU Amsterdam</Link> /
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3">{course.name} at Vrije Universiteit Amsterdam — Fees in INR, IELTS &amp; Requirements for Indian Students</h1>
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="vrije-universiteit-amsterdam-${slug}" defaultCountry="Netherlands" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <CourseRichContent course={course as any} universityName="Vrije Universiteit Amsterdam" universitySlug="vrije-universiteit-amsterdam" />
        ...
        <div>
          <div className="sticky top-20">
            <LeadForm source="vrije-universiteit-amsterdam-detail-sidebar" defaultCountry="Netherlands" />
          </div>
        </div>
      </div>
    </>
