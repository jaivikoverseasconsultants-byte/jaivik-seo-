...
export function generateStaticParams() {
  return vrijeUniversiteitAmsterdamCourses.map(c => ({ slug: c.slug }));
}
...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at Vrije Universiteit Amsterdam — Fees, IELTS & Intake for Indian Students 2026`,
