...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at KTH Royal Institute of Technology 2026 – Fees, IELTS & Requirements`,
    description: `${course.name} at KTH Royal Institute of Technology: ${course.duration}, SEK ${course.annualSEK.toLocaleString()}/SEK/yr. IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas.`,
