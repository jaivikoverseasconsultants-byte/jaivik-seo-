...
const UNIVERSITY_SLUG = 'victoria-university-wellington';
...
export default function CoursesPage() {
  const courses = vuwCourses as unknown as any[];
  ...
  const schema = {
    ...
    name: 'Victoria University of Wellington', sameAs: 'https://www.wgtn.ac.nz',
    address: { '@type': 'PostalAddress', addressLocality: 'Wellington', addressRegion: 'Wellington', addressCountry: 'NZ' },
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              ...
              <p className="text-blue-200 text-lg mb-5">
                {total} programs · {avgFee > 0 ? `Avg NZ$${avgFee.toLocaleString()}/yr` : 'Fees on request'} · IELTS 6.5+ · February & July intakes
              </p>
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="vuw-courses-index" defaultCountry="New Zealand" compact />
            </div>
          </div>
        </div>
      </section>
            ...
            <div key={level}>
              ...
              <div className="space-y-3">
                {(lvC as any[]).sort((a: any, b: any) => a.name.localeCompare(b.name)).map((c: any) => (
                  <Link key={c.slug} href={`/universities/victoria-university-wellington/courses/${c.slug}`}
