...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} | UofT – Fees, IELTS & Intake 2026`,
    description: `${course.name} at University of Toronto. Annual fee CAD $${course.annualCAD.toLocaleString()} (${course.durationYears} year${course.durationYears !== 1 ? 's' : ''}). IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. PGWP eligible. Free guidance from Jaivik Overseas Consultants.`,
