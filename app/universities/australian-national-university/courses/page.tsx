...
export const metadata: Metadata = buildMetadata({
  title: 'Australian National University International Courses – All Programs, Fees & IELTS 2026',
  ...
  keywords: ['ANU courses', 'Australian National University international', 'ANU fees', 'study in Australia', 'Australia university'],
});
...
export default function CoursesPage() {
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Australian National University offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
  ...
  const schema = {
    ...
    name: 'Australian National University', sameAs: 'https://www.anu.edu.au',
    address: { '@type': 'PostalAddress', addressLocality: 'Canberra', addressRegion: 'ACT', addressCountry: 'undefined' },
  };
            ...
            <div className="lg:col-span-2">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {[
                  ...
                  { label: 'QS Ranking', value: '#30 QS' },
                  { label: 'Avg PG Fee', value: `A$${Math.round(avgFee/1000)}K` },
                  { label: 'Campus', value: 'Canberra' },
                ].map(s => (
