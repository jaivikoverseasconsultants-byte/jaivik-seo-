...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} | ANU – Fees, IELTS & Intake 2026`,
    description: `${course.name} at Australian National University. Annual fee A$${course.annualAUD.toLocaleString()} (${course.durationYears} year${course.durationYears !== 1 ? 's' : ''}). IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas Consultants.`,
...
export default async function CoursePage(
  ...
  const schema = {
    ...
    name: course.name,
    provider: { '@type': 'CollegeOrUniversity', name: 'Australian National University', sameAs: 'https://www.anu.edu.au' },
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4">
            ...
            <Link href="/universities/australian-national-university/courses" className="hover:text-white">Courses</Link> /
          ...
          <div className="sticky top-20">
            ...
            <div className="mt-4 bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <Link href="/universities/australian-national-university/courses" className="block text-sm text-brand-700 hover:underline">All ANU Courses →</Link>
