...
import { lseCourses, getLseCourseBySlug } from '@/data/lse-courses';
...
export async function generateStaticParams() {
  return (lseCourses as unknown as any[]).map((c: any) => ({ slug: c.slug }));
}
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4">
            ...
            <Link href="/universities/london-school-of-economics" className="hover:text-white">LSE</Link> /
            <Link href="/universities/london-school-of-economics/courses" className="hover:text-white">Courses</Link> /
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source={`lse-course-${slug}`} defaultCountry="UK" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <CourseRichContent course={course as any} universityName="London School of Economics" universitySlug="london-school-of-economics" />
        ...
        <div className="space-y-5">
          <div className="sticky top-20">
            <LeadForm source={`lse-course-${slug}-sidebar`} defaultCountry="UK" />
            <div className="mt-4 bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <Link href="/universities/london-school-of-economics/courses" className="block text-sm text-brand-700 hover:underline">
                  All LSE Courses →
                </Link>
