...
export const metadata: Metadata = buildMetadata({
  title: 'TU Dresden International Courses – Programs, Fees & IELTS 2026',
...
export default function CoursesPage() {
  const courses = tudresdenCourses as unknown as any[];
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `How many courses does TU Dresden offer for international students?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `TU Dresden offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at TU Dresden?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at TU Dresden is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the average tuition fee at TU Dresden?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at TU Dresden is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * 84 / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      },
      {
        '@type': 'Question',
        name: `What intake options does TU Dresden offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `TU Dresden offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to TU Dresden?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to TU Dresden in Germany through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `TU Dresden — Courses for International Students`,
    description: `${courses.length} programs at TU Dresden, Germany. Min IELTS ${_minIelts}+.`,
    ...
    itemListElement: courses.slice(0, 5).map((c: any, i: number) => ({
      ...
      item: {
        '@type': 'Course',
        name: c.name,
        provider: { '@type': 'CollegeOrUniversity', name: 'TU Dresden' },
  ...
  const schema = {
    ...
    name: 'TU Dresden', sameAs: 'https://tu-dresden.de/en/',
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4">
            ...
            <span className="text-white">TU Dresden</span>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="tudresden-courses-index" defaultCountry="Germany" compact />
            </div>
          </div>
        </div>
      </section>
            ...
            <div key={level}>
              ...
              <div className="space-y-3">
                {(lvC as any[]).sort((a: any, b: any) => a.name.localeCompare(b.name)).map((c: any) => (
                  <Link key={c.slug} href={`/universities/tu-dresden/courses/${c.slug}`}
