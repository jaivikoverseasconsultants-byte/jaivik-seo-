...
export function generateStaticParams() {
  return murdochUniversityDubaiCourses.map(c => ({ slug: c.slug }));
}
...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at Murdoch University Dubai 2026 – Fees, IELTS & Requirements`,
    description: `${course.name} at Murdoch University Dubai: ${course.duration}, AED ${course.annualAED.toLocaleString()}/AED/yr. IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas.`,
