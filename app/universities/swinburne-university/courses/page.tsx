...
export const metadata: Metadata = buildMetadata({
  title: 'Swinburne International Courses â€“ All Programs, Fees & IELTS 2026',
  description: `Swinburne University of Technology â€” ${(swinburneCourses as unknown as any[]).length} courses for international students. IELTS 6.5+. February & July intakes. Free admission guidance from Jaivik Overseas Consultants.`,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                Swinburne University of Technology â€” International Courses
              </h1>
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-3 text-sm">Quick Facts â€” Swinburne</h3>
              {[
                ['Established', '1908'],
