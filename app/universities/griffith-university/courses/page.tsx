...
export const metadata: Metadata = buildMetadata({
  title: 'Griffith International Courses â€“ All Programs, Fees & IELTS 2026',
  description: `Griffith University â€” ${(griffithCourses as unknown as any[]).length} courses for international students. IELTS 6+. February & July intakes. Free admission guidance from Jaivik Overseas Consultants.`,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              <div className="inline-flex items-center gap-2 bg-gold-500/20 text-gold-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
                ðŸ‡¦ðŸ‡º Brisbane, Australia Â· #320 QS World Ranking
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                Griffith University â€” International Courses
              </h1>
