...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${c.name} at James Cook University Singapore 2026 – Fees, IELTS & Requirements`,
    description: `${c.name} at James Cook University Singapore: ${c.duration}, S$${(c.annualSGD/1000).toFixed(0)}K SGD/yr. IELTS ${c.ieltsMin}+. Apply via Jaivik Overseas Consultants.`,
