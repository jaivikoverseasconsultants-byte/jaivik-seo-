...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at Humboldt University of Berlin — Fees in INR, IELTS & Requirements for Indian Students`,
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4 flex-wrap">
            ...
            <Link href="/universities/humboldt-university-of-berlin/courses" className="hover:text-white">Courses</Link> /
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-3">{course.name} at Humboldt University of Berlin — Fees in INR, IELTS &amp; Requirements for Indian Students</h1>
          <p className="text-blue-100 text-lg">
            Humboldt University of Berlin · Berlin, Germany · {course.duration}
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Why Humboldt */}
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              <h2 className="text-xl font-bold text-gray-900 mb-4">Why Choose Humboldt University of Berlin?</h2>
          ...
          <CourseRichContent course={course as any} universityName="Humboldt University of Berlin" universitySlug="humboldt-university-of-berlin" />
          <div className="bg-brand-700 text-white rounded-2xl p-6">
            ...
            <Link href="/universities/humboldt-university-of-berlin/courses" className="flex items-center gap-2 text-brand-700 hover:text-brand-900 font-medium text-sm">
              ← All Humboldt Courses
            </Link>
          </div>
        </div>
      </section>
