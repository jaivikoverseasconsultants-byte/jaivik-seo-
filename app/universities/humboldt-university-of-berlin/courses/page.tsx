...
export const metadata: Metadata = buildMetadata({
  ...
  path: '/universities/humboldt-university-of-berlin/courses',
  keywords: ['Humboldt courses', 'Humboldt University of Berlin international', 'study in Germany'],
});
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4">
            ...
            <Link href="/universities/humboldt-university-of-berlin" className="hover:text-white">Humboldt</Link> /
            <span>Courses</span>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {levelCourses.map((course: any) => {
                ...
                return (
                  <Link
                    key={course.id}
                    href={`/universities/humboldt-university-of-berlin/courses/${course.slug}`}
      ...
      <section className="bg-brand-50 py-12 px-4">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-2xl font-bold text-center text-brand-900 mb-2">Apply to Humboldt</h2>
