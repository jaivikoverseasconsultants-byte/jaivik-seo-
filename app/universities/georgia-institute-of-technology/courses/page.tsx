...
export const metadata: Metadata = buildMetadata({
  ...
  path: '/universities/georgia-institute-of-technology/courses',
...
export default function CoursesPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `How many courses does Georgia Institute of Technology offer for international students?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Georgia Institute of Technology offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at Georgia Institute of Technology?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at Georgia Institute of Technology is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the average tuition fee at Georgia Institute of Technology?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at Georgia Institute of Technology is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * 84 / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      },
      {
        '@type': 'Question',
        name: `What intake options does Georgia Institute of Technology offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Georgia Institute of Technology offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to Georgia Institute of Technology?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to Georgia Institute of Technology in USA through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `Georgia Institute of Technology — Courses for International Students`,
    description: `${courses.length} programs at Georgia Institute of Technology, USA. Min IELTS ${_minIelts}+.`,
    ...
    itemListElement: courses.slice(0, 5).map((c: any, i: number) => ({
      ...
      item: {
        '@type': 'Course',
        name: c.name,
        provider: { '@type': 'CollegeOrUniversity', name: 'Georgia Institute of Technology' },
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4">
            ...
            <Link href="/universities/georgia-institute-of-technology" className="hover:text-white">Georgia Tech</Link> /
            <span>Courses</span>
          </div>
          <h1 className="text-3xl md:text-4xl font-bold mb-3">Georgia Institute of Technology</h1>
          <p className="text-blue-100 text-lg mb-6">
            {totalCourses} Programs for International Students · Atlanta, USA · IELTS 6.0–7.0+
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {levelCourses.map((course: any) => {
                ...
                return (
                  <Link
                    key={course.id}
                    href={`/universities/georgia-institute-of-technology/courses/${course.slug}`}
      ...
      <section className="bg-brand-50 py-12 px-4">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-2xl font-bold text-center text-brand-900 mb-2">Apply to Georgia Tech</h2>
