...
export async function generateMetadata(
  ...
  return buildMetadata({
    ...
    description: `${course.name} at Georgia Institute of Technology. Annual fee $${fee.toLocaleString()} (${course.durationYears} year${course.durationYears !== 1 ? 's' : ''}). IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas Consultants.`,
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4 flex-wrap">
            ...
            <Link href="/universities/georgia-institute-of-technology/courses" className="hover:text-white">Courses</Link> /
      ...
      <section className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {[
                  ...
                  { label: 'Campus', value: course.campus?.split(',')[0] || 'Atlanta', sub: 'USA' },
                ].map(({ label, value, sub }) => (
            ...
            {/* Why Georgia Tech */}
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              <h2 className="text-xl font-bold text-gray-900 mb-4">Why Choose Georgia Institute of Technology?</h2>
          ...
          <div className="bg-brand-700 text-white rounded-2xl p-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-5">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">${(course as any)['livingCostUSD']?.toLocaleString() || 'N/A'}/year</span>
                </div>
                <div className="flex justify-between">
            ...
            <Link href="/universities/georgia-institute-of-technology/courses" className="flex items-center gap-2 text-brand-700 hover:text-brand-900 font-medium text-sm">
              ← All Georgia Tech Courses
            </Link>
          </div>
        </div>
      </section>
