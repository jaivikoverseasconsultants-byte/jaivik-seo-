...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${c.name} at Arizona State University 2026 – Fees, IELTS & Requirements`,
    description: `${c.name} at Arizona State University: ${c.duration}, $${(c.annualUSD/1000).toFixed(0)}K USD/yr. IELTS ${c.ieltsMin}+. Apply via Jaivik Overseas Consultants.`,
