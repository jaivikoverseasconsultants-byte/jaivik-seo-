...
import { edinburghCourses, getEdinburghCourseBySlug } from '@/data/edinburgh-courses';
...
export async function generateMetadata(
  ...
  const course = getEdinburghCourseBySlug(slug);
  if (!course) return {};
  const fee = (course as any).annualGBP || (course as any).annualUSD || 0;
  return buildMetadata({
    title: `${course.name} | Edinburgh – Fees, IELTS & Intake 2026`,
    description: `${course.name} at University of Edinburgh. Annual fee £${fee.toLocaleString()} (${course.durationYears} year${course.durationYears !== 1 ? 's' : ''}). IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas Consultants.`,
...
export default async function CoursePage(
  ...
  const totalFee = (course as any)['totalGBP'] || fee * course.durationYears;
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4 flex-wrap">
            ...
            <Link href="/universities/university-of-edinburgh/courses" className="hover:text-white">Courses</Link> /
      ...
      <section className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Why Edinburgh */}
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              <h2 className="text-xl font-bold text-gray-900 mb-4">Why Choose University of Edinburgh?</h2>
          ...
          <CourseRichContent course={course as any} universityName="University of Edinburgh" universitySlug="university-of-edinburgh" />
          <div className="bg-brand-700 text-white rounded-2xl p-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-5">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">£{(course as any)['livingCostGBP']?.toLocaleString() || 'N/A'}/year</span>
                </div>
                <div className="flex justify-between">
            ...
            <Link href="/universities/university-of-edinburgh/courses" className="flex items-center gap-2 text-brand-700 hover:text-brand-900 font-medium text-sm">
              ← All Edinburgh Courses
            </Link>
          </div>
        </div>
      </section>
