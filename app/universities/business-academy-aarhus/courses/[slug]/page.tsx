...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at Business Academy Aarhus 2026 – Fees, IELTS & Requirements`,
    description: `${course.name} at Business Academy Aarhus: ${course.duration}, DKK ${course.annualDKK.toLocaleString()}/DKK/yr. IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas.`,
