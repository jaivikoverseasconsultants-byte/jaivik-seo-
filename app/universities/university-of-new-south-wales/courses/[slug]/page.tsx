...
import { unswCourses, getUnswCourseBySlug } from '@/data/unsw-courses';
...
export async function generateStaticParams() {
  return (unswCourses as unknown as any[]).map((c: any) => ({ slug: c.slug }));
}
...
export async function generateMetadata(
  ...
  const course = getUnswCourseBySlug(slug);
  if (!course) return {};
  const fee = (course as any).annualAUD || (course as any).annualUSD || 0;
  return buildMetadata({
    title: `${course.name} at UNSW Sydney — Fees in INR, IELTS & Requirements for Indian Students`,
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4 flex-wrap">
            ...
            <Link href="/universities/university-of-new-south-wales/courses" className="hover:text-white">Courses</Link> /
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-3">{course.name} at UNSW Sydney — Fees in INR, IELTS &amp; Requirements for Indian Students</h1>
          <p className="text-blue-100 text-lg">
            UNSW Sydney · Sydney, Australia · {course.duration}
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {[
                  ...
                  { label: 'Campus', value: course.campus?.split(',')[0] || 'Sydney', sub: 'Australia' },
                ].map(({ label, value, sub }) => (
            ...
            {/* Why UNSW */}
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              <h2 className="text-xl font-bold text-gray-900 mb-4">Why Choose UNSW Sydney?</h2>
          ...
          <CourseRichContent course={course as any} universityName="UNSW Sydney" universitySlug="university-of-new-south-wales" />
          <div className="bg-brand-700 text-white rounded-2xl p-6">
            ...
            <Link href="/universities/university-of-new-south-wales/courses" className="flex items-center gap-2 text-brand-700 hover:text-brand-900 font-medium text-sm">
              ← All UNSW Courses
            </Link>
          </div>
        </div>
