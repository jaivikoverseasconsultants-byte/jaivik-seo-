...
export default function CoursesPage() {
  ...
  const schema = {
    ...
    name: 'UNSW Sydney', sameAs: 'https://www.unsw.edu.au', url: 'https://www.unsw.edu.au',
  };
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-blue-100 text-lg mb-6">{totalCourses} Programs · Sydney, Australia · IELTS 6.0–7.0+</p>
          <div className="flex flex-wrap gap-4">
            ...
            <div className="bg-white/10 rounded-xl px-5 py-3 text-center"><div className="text-2xl font-bold">A${avgFee.toLocaleString()}</div><div className="text-blue-200 text-xs">Avg PG Fee/year</div></div>
                ...
                return (
                  <Link key={course.id} href={`/universities/unsw-sydney/courses/${course.slug}`}
                    ...
                    <div className="flex flex-wrap gap-2 text-xs">
                      ...
                      <span className="bg-green-50 text-green-700 px-2 py-0.5 rounded-full">A${fee.toLocaleString()}/yr</span>
