...
import { middlesexUniversityDubaiCourses, getMiddlesexUniversityDubaiCourseBySlug } from '@/data/middlesex-university-dubai-courses';
...
export async function generateStaticParams() {
  return (middlesexUniversityDubaiCourses as unknown as any[]).map((c: any) => ({ slug: c.slug }));
}
...
export default async function CourseDetailPage(
  ...
  const schema = {
    ...
    '@type': 'Course',
    name: course.name,
    provider: { '@type': 'CollegeOrUniversity', name: 'Middlesex University Dubai', sameAs: 'https://www.mdx.ac.ae' },
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4 flex-wrap">
            ...
            <Link href="/universities/middlesex-university-dubai/courses" className="hover:text-white">MDX Dubai</Link> /
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="middlesex-university-dubai-${slug}" defaultCountry="UAE" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <CourseRichContent course={course as any} universityName="Middlesex University Dubai" universitySlug="middlesex-university-dubai" />
        ...
        <div>
          <div className="sticky top-20">
            <LeadForm source="middlesex-university-dubai-detail-sidebar" defaultCountry="UAE" />
          </div>
        </div>
      </div>
    </>
