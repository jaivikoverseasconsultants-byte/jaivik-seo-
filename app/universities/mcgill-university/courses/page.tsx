...
import { mcgillCourses } from '@/data/mcgill-courses';
...
const UNIVERSITY_SLUG = 'mcgill-university';

export const metadata: Metadata = buildMetadata({
  title: 'McGill Courses — Fees & IELTS 2026',
  description: `McGill University — ${(mcgillCourses as unknown as any[]).length} courses for international students. PGWP Eligible · IELTS 6.5+. September & January intakes. Free admission guidance from Jaivik Overseas Consultants.`,
  path: '/universities/mcgill-university/courses',
  keywords: ['McGill courses', 'McGill University international', 'McGill fees', 'study in Canada', 'Canada university', 'PGWP'],
});
...
export default function CoursesPage() {
  const courses = mcgillCourses as unknown as any[];
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `How many courses does McGill University offer for international students?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `McGill University offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at McGill University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at McGill University is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      ...(_avgFeeUSD > 0 ? [{
        '@type': 'Question',
        name: `What is the average tuition fee at McGill University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at McGill University is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * RATE_TO_INR.USD / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      }] : []),
      {
        '@type': 'Question',
        name: `What intake options does McGill University offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `McGill University offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to McGill University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to McGill University in Canada through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `McGill University — Courses for International Students`,
    description: `${courses.length} programs at McGill University, Canada. Min IELTS ${_minIelts}+.`,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              <div className="inline-flex items-center gap-2 bg-gold-500/20 text-gold-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
                🇨🇦 Montreal, Canada · PGWP Eligible · #32 QS
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                McGill University — International Courses
              </h1>
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="mcgill-courses-index" defaultCountry="Canada" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div key={level}>
              ...
              <div className="space-y-3">
                {(lvCourses as any[]).sort((a: any, b: any) => a.name.localeCompare(b.name)).map((c: any) => (
                  <Link key={c.slug} href={`/universities/mcgill-university/courses/${c.slug}`}
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            <LeadForm source="mcgill-courses-sidebar" defaultCountry="Canada" />
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-3 text-sm">Quick Facts — McGill</h3>
              {[
                ['Established', '1821'],
