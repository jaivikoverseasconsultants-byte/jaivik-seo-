...
import { humboldtCourses } from '@/data/humboldt-courses';
import LeadForm from '@/components/LeadForm';
import JsonLd from '@/components/JsonLd';

export const metadata: Metadata = buildMetadata({
  title: 'Humboldt University of Berlin International Courses – All Programs, Fees & IELTS 2026',
  description: `Humboldt University of Berlin – ${(humboldtCourses as unknown as any[]).length} courses for international students. Free guidance from Jaivik Overseas Consultants.`,
  path: '/universities/humboldt-university-berlin/courses',
  keywords: ['Humboldt Berlin courses', 'Humboldt University of Berlin international', 'study in Germany'],
});
...
export default function CoursesPage() {
  const courses = humboldtCourses as unknown as any[];
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `How many courses does Humboldt University of Berlin offer for international students?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Humboldt University of Berlin offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at Humboldt University of Berlin?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at Humboldt University of Berlin is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the average tuition fee at Humboldt University of Berlin?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at Humboldt University of Berlin is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * 84 / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      },
      {
        '@type': 'Question',
        name: `What intake options does Humboldt University of Berlin offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Humboldt University of Berlin offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to Humboldt University of Berlin?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to Humboldt University of Berlin in Germany through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `Humboldt University of Berlin — Courses for International Students`,
    description: `${courses.length} programs at Humboldt University of Berlin, Germany. Min IELTS ${_minIelts}+.`,
    ...
    itemListElement: courses.slice(0, 5).map((c: any, i: number) => ({
      ...
      item: {
        '@type': 'Course',
        name: c.name,
        provider: { '@type': 'CollegeOrUniversity', name: 'Humboldt University of Berlin' },
  ...
  const schema = {
    ...
    name: 'Humboldt University of Berlin', sameAs: 'https://www.hu-berlin.de', url: 'https://www.hu-berlin.de',
  };
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4">
            ...
            <Link href="/universities/humboldt-university-berlin" className="hover:text-white">Humboldt Berlin</Link> /
            <span>Courses</span>
          </div>
          <h1 className="text-3xl md:text-4xl font-bold mb-3">Humboldt University of Berlin</h1>
          ...
          <div key={level} className="mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {levelCourses.map((course: any) => {
                ...
                return (
                  <Link key={course.id} href={`/universities/humboldt-university-berlin/courses/${course.slug}`}
      ...
      <section className="bg-brand-50 py-12 px-4"><div className="max-w-2xl mx-auto"><h2 className="text-2xl font-bold text-center text-brand-900 mb-2">Apply to Humboldt Berlin</h2><p className="text-center text-gray-600 mb-6">Get free expert guidance from Jaivik Overseas Consultants</p><LeadForm /></div></section>
    </>
  );
}
