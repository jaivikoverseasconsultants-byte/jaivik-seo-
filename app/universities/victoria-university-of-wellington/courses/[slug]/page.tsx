...
import { victoriaCourses, getVictoriaCourseBySlug } from '@/data/victoria-courses';
...
export async function generateStaticParams() {
  return (victoriaCourses as unknown as any[]).map((c: any) => ({ slug: c.slug }));
}
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4 flex-wrap">
            ...
            <Link href="/universities/victoria-university-of-wellington/courses" className="hover:text-white">Victoria Wellington</Link> /
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="victoria-university-of-wellington-${slug}" defaultCountry="New Zealand" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <CourseRichContent course={course as any} universityName="Victoria University of Wellington" universitySlug="victoria-university-of-wellington" />
        ...
        <div>
          <div className="sticky top-20">
            <LeadForm source="victoria-university-of-wellington-detail-sidebar" defaultCountry="New Zealand" />
          </div>
        </div>
      </div>
    </>
