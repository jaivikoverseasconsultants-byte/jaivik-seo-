...
import { durhamCourses, getDurhamCourseBySlug } from '@/data/durham-courses';
...
const UNIVERSITY_SLUG = 'durham-college';

function courseParams() {
  return (durhamCourses as unknown as any[]).map((c) => ({ slug: c.slug }));
}

async function courseMetadata(slug: string): Promise<Metadata> {
  const course = getDurhamCourseBySlug(slug) as any;
  if (!course) return {};
  const english = englishTests(course).some((t) => t.label === 'IELTS Academic') ? ` IELTS ${course.ieltsMin}+.` : '';
  return buildMetadata({
    title: `${course.name} at Durham College`,
    description: `${course.name} at Durham College, Oshawa${feeSentenceINR(course, course.annualINR)}${english} Apply with Jaivik Overseas — 13 years expertise, 99% visa success.`,
    path: `/universities/durham-college/courses/${slug}`,
    keywords: [course.name, 'Durham College', 'Durham College', 'study in Canada', course.level],
  });
}
...
async function CourseView({ slug }: { slug: string }) {
  ...
  const schema = {
    ...
    '@type': 'Course',
    name: course.name,
    provider: { '@type': 'CollegeOrUniversity', name: 'Durham College', sameAs: 'https://durhamcollege.ca' },
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4 flex-wrap">
            ...
            <Link href="/universities/durham-college" className="hover:text-white">Durham College</Link> /
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3">{course.name} at Durham College — {titleFeeFragment(course, course.annualINR)}Requirements for Indian Students</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
            ...
            {englishTests(course).length > 0 ? (
              ...
              <p className="text-sm text-gray-600">
                Durham College doesn’t publish a single English score that applies to this programme.
          ...
          <CourseRichContent course={course} universityName="Durham College" universitySlug="durham-college" />
          ...
          <div className="sticky top-20">
            ...
            <div className="mt-4 bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <Link href="/universities/durham-college/courses" className="block text-sm text-brand-700 hover:underline">All Durham College Courses →</Link>
