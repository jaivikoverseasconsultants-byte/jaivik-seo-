...
export const metadata: Metadata = buildMetadata({
  title: 'Durham International Courses â€“ All Programs, Fees & IELTS 2026',
  description: `Durham College â€” ${(durhamCourses as unknown as any[]).length} courses for international students. PGWP Eligible Â· IELTS 6+. September & January intakes. Free admission guidance from Jaivik Overseas Consultants.`,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                Durham College â€” International Courses
              </h1>
