...
import { universityOfLyonCourses, getUniversityOfLyonCourseBySlug } from '@/data/university-of-lyon-courses';
...
export async function generateStaticParams() {
  return (universityOfLyonCourses as unknown as any[]).map((c: any) => ({ slug: c.slug }));
}
...
export default async function CourseDetailPage(
  ...
  const schema = {
    ...
    '@type': 'Course',
    name: course.name,
    provider: { '@type': 'CollegeOrUniversity', name: 'University of Lyon', sameAs: 'https://www.universite-lyon.fr' },
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4 flex-wrap">
            ...
            <Link href="/universities/university-of-lyon/courses" className="hover:text-white">Lyon Univ</Link> /
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="university-of-lyon-${slug}" defaultCountry="France" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <CourseRichContent course={course as any} universityName="University of Lyon" universitySlug="university-of-lyon" />
        ...
        <div>
          <div className="sticky top-20">
            <LeadForm source="university-of-lyon-detail-sidebar" defaultCountry="France" />
          </div>
        </div>
      </div>
    </>
