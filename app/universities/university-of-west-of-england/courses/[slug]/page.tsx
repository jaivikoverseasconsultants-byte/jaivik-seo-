...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at University of the West of England — Fees in INR, IELTS & Requirements for Indian Students`,
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3">{course.name} at University of the West of England — Fees in INR, IELTS &amp; Requirements for Indian Students</h1>
