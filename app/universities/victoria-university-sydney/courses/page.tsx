...
export const metadata: Metadata = buildMetadata({
  title: 'VU Sydney Courses — Fees & IELTS 2026',
...
export default function CoursesPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `How many courses does Victoria University Sydney offer for international students?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Victoria University Sydney offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at Victoria University Sydney?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at Victoria University Sydney is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      ...(_avgFeeUSD > 0 ? [{
        '@type': 'Question',
        name: `What is the average tuition fee at Victoria University Sydney?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at Victoria University Sydney is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * RATE_TO_INR.USD / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      }] : []),
      {
        '@type': 'Question',
        name: `What intake options does Victoria University Sydney offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Victoria University Sydney offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to Victoria University Sydney?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to Victoria University Sydney in Australia through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `Victoria University Sydney — Courses for International Students`,
    description: `${courses.length} programs at Victoria University Sydney, Australia. Min IELTS ${_minIelts}+.`,
    ...
    itemListElement: courses.slice(0, 5).map((c: any, i: number) => ({
      ...
      item: {
        '@type': 'Course',
        name: c.name,
        provider: { '@type': 'CollegeOrUniversity', name: 'Victoria University Sydney' },
