...
import { bondCourses } from '@/data/bond-courses';
import LeadForm from '@/components/LeadForm';
import JsonLd from '@/components/JsonLd';

export const metadata: Metadata = buildMetadata({
  title: 'Bond University International Courses – All Programs, Fees & IELTS 2026',
  description: `Bond University — ${(bondCourses as unknown as any[]).length} courses for international students. IELTS 6.5+. January & May & September intakes. Free admission guidance from Jaivik Overseas Consultants.`,
  path: '/universities/bond-university/courses',
  keywords: ['Bond courses', 'Bond University international', 'Bond fees', 'study in Australia', 'Australia university'],
});
...
export default function CoursesPage() {
  const courses = bondCourses as unknown as any[];
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `How many courses does Bond University offer for international students?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Bond University offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at Bond University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at Bond University is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the average tuition fee at Bond University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at Bond University is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * 84 / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      },
      {
        '@type': 'Question',
        name: `What intake options does Bond University offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Bond University offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to Bond University?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to Bond University in Australia through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `Bond University — Courses for International Students`,
    description: `${courses.length} programs at Bond University, Australia. Min IELTS ${_minIelts}+.`,
  ...
  const schema = {
    ...
    name: 'Bond University', sameAs: 'https://www.bond.edu.au',
    address: { '@type': 'PostalAddress', addressLocality: 'Gold Coast', addressRegion: 'Queensland', addressCountry: 'undefined' },
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              <div className="inline-flex items-center gap-2 bg-gold-500/20 text-gold-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
                🇦🇺 Gold Coast, Australia · QS 501+ World Ranking
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                Bond University — International Courses
              </h1>
              <p className="text-blue-200 text-lg mb-5">
                {totalCourses} programs · Avg A${avgFee.toLocaleString()}/yr · IELTS 6.5+ · January & May & September intakes
              </p>
            ...
            <div className="bg-white rounded-2xl p-5">
              <LeadForm source="bond-courses-index" defaultCountry="Australia" compact />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            <LeadForm source="bond-courses-sidebar" defaultCountry="Australia" />
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-3 text-sm">Quick Facts — Bond</h3>
              {[
                ['Established', '1989'],
