...
export const metadata: Metadata = buildMetadata({
  title: 'Edith Cowan University International Courses – All Programs, Fees & IELTS 2026',
  ...
  keywords: ['ECU courses', 'Edith Cowan University international', 'ECU fees', 'study in Australia', 'Australia university'],
});
...
export default function CoursesPage() {
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Edith Cowan University offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at Edith Cowan University is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at Edith Cowan University is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * 84 / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      },
      {
        '@type': 'Question',
  ...
  const schema = {
    ...
    name: 'Edith Cowan University', sameAs: 'https://www.ecu.edu.au',
