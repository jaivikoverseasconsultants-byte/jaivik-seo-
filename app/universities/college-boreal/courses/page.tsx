...
export const metadata: Metadata = buildMetadata({
  title: 'BorÃ©al International Courses â€“ All Programs, Fees & IELTS 2026',
  description: `CollÃ¨ge BorÃ©al â€” ${(borealCourses as unknown as any[]).length} courses for international students. PGWP Eligible Â· IELTS 6+. September & January intakes. Free admission guidance from Jaivik Overseas Consultants.`,
  path: '/universities/college-boreal/courses',
  keywords: ['BorÃ©al courses', 'CollÃ¨ge BorÃ©al international', 'BorÃ©al fees', 'study in Canada', 'Canada university', 'PGWP'],
});
      ...
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-blue-200 text-xs mb-4">
            ...
            <span className="text-white">BorÃ©al</span>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                CollÃ¨ge BorÃ©al â€” International Courses
              </h1>
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-3 text-sm">Quick Facts â€” BorÃ©al</h3>
              {[
                ['Established', '1995'],
