...
export async function generateStaticParams() {
  return (karolinskaInstitutetCourses as unknown as any[]).map((c: any) => ({ slug: c.slug }));
}
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <CourseRichContent course={course as any} universityName="Karolinska Institutet" universitySlug="karolinska-institutet" />
