...
export const metadata: Metadata = buildMetadata({
  title: 'University of New Brunswick Courses — Fees & Requirements 2026',
  description: `University of New Brunswick — ${(unbCourses as unknown as any[]).length} programmes for international students in Fredericton, Canada. Free admission guidance from Jaivik Overseas Consultants.`,
  path: '/universities/university-of-new-brunswick/courses',
  keywords: ['UNB courses', 'University of New Brunswick international', 'study in Canada', 'Fredericton'],
});
...
export default function CoursesPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How many programmes does University of New Brunswick offer for international students?',
        acceptedAnswer: { '@type': 'Answer', text: `University of New Brunswick lists ${courses.length} programmes in our course finder, each linked to its official page.` },
      },
      ...(avgFeeUSD > 0 ? [{
        '@type': 'Question',
        name: 'What is the average international tuition at University of New Brunswick?',
        acceptedAnswer: { '@type': 'Answer', text: `Across the ${verified.length} programmes where University of New Brunswick publishes an international fee, the average is about ${avgFeeUSD.toLocaleString()} USD (≈ ₹${(avgFeeUSD * RATE_TO_INR.USD / 100000).toFixed(1)}L) a year.` },
      }] : []),
      {
        '@type': 'Question',
        name: 'How can Indian students apply to University of New Brunswick?',
        acceptedAnswer: { '@type': 'Answer', text: 'Indian students can apply to University of New Brunswick through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.' },
      },
    ],
  };
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3">University of New Brunswick — International Courses</h1>
