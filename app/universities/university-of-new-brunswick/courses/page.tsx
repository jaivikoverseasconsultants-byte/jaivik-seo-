...
export const metadata: Metadata = buildMetadata({
  title: 'UNB International Courses – All Programs, Fees & IELTS 2026',
  description: `University of New Brunswick — ${(unbCourses as unknown as any[]).length} courses for international students. PGWP Eligible · IELTS 6.5+. September & January intakes. Free admission guidance from Jaivik Overseas Consultants.`,
...
export default function CoursesPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `How many courses does University of New Brunswick offer for international students?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `University of New Brunswick offers ${courses.length} programs for international students including Undergraduate, Master's, and PhD degrees.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the minimum IELTS score required at University of New Brunswick?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The minimum IELTS score at University of New Brunswick is ${_minIelts}+. High-demand programs may require up to 7.0.`,
        },
      },
      {
        '@type': 'Question',
        name: `What is the average tuition fee at University of New Brunswick?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `The average annual tuition at University of New Brunswick is approximately ${_avgFeeUSD.toLocaleString()} USD (≈ ₹${(_avgFeeUSD * 84 / 100000).toFixed(1)}L INR). Fees vary by program and level.`,
        },
      },
      {
        '@type': 'Question',
        name: `What intake options does University of New Brunswick offer?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `University of New Brunswick offers ${_intakesText} intake${_intakeSample.length > 1 ? 's' : ''}. Apply 3–6 months before the intake opening.`,
        },
      },
      {
        '@type': 'Question',
        name: `How can Indian students apply to University of New Brunswick?`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Indian students can apply to University of New Brunswick in Canada through Jaivik Overseas Consultants — free application guidance, SOP writing, and visa assistance included.`,
        },
      },
    ],
  };
  ...
  const courseListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `University of New Brunswick — Courses for International Students`,
    description: `${courses.length} programs at University of New Brunswick, Canada. Min IELTS ${_minIelts}+.`,
    ...
    itemListElement: courses.slice(0, 5).map((c: any, i: number) => ({
      ...
      item: {
        '@type': 'Course',
        name: c.name,
        provider: { '@type': 'CollegeOrUniversity', name: 'University of New Brunswick' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              <div className="inline-flex items-center gap-2 bg-gold-500/20 text-gold-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
                🇨🇦 Fredericton, Canada · PGWP Eligible · #801 QS
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                University of New Brunswick — International Courses
              </h1>
        ...
        <div>
          <div className="sticky top-20 space-y-5">
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-3 text-sm">Quick Facts — UNB</h3>
              {[
                ['Established', '1785'],
