...
import { unbCourses, getUnbCourseBySlug } from '@/data/unb-courses';
...
const PUBLISHED_TESTS = {"ielts":true,"toefl":true,"pte":true};
...
const UNIVERSITY_SLUG = 'university-of-new-brunswick';

function courseParams() {
  return (unbCourses as unknown as any[]).map((c) => ({ slug: c.slug }));
}

async function courseMetadata(slug: string): Promise<Metadata> {
  const course = getUnbCourseBySlug(slug) as any;
  if (!course) return {};
  const english = englishTests(course).some((t) => t.label === 'IELTS Academic') ? ` IELTS ${course.ieltsMin}+.` : '';
  return buildMetadata({
    title: `${course.name} at University of New Brunswick`,
    description: `${course.name} at University of New Brunswick, Fredericton${feeSentenceINR(course, course.annualINR)}${english} Apply with Jaivik Overseas — 13 years expertise, 99% visa success.`,
    path: `/universities/university-of-new-brunswick/courses/${slug}`,
    keywords: [course.name, 'UNB', 'University of New Brunswick', 'study in Canada', course.level],
  });
}
...
async function CourseView({ slug }: { slug: string }) {
  ...
  const schema = {
    ...
    '@type': 'Course',
    name: course.name,
    provider: { '@type': 'CollegeOrUniversity', name: 'University of New Brunswick', sameAs: 'https://www.unb.ca' },
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3">{course.name} at University of New Brunswick — {titleFeeFragment(course, course.annualINR)}Requirements for Indian Students</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
            ...
            {englishTests(course).length > 0 ? (
              ...
              <p className="text-sm text-gray-600">
                University of New Brunswick doesn’t publish a single English score that applies to this programme.
          ...
          <CourseRichContent course={course} universityName="University of New Brunswick" universitySlug="university-of-new-brunswick" />
          ...
          <div className="sticky top-20">
            ...
            <div className="mt-4 bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <Link href="/universities/university-of-new-brunswick/courses" className="block text-sm text-brand-700 hover:underline">All UNB Courses →</Link>
