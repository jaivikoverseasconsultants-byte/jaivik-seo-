...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at University of Montpellier 2026 – Fees, IELTS & Requirements`,
    description: `${course.name} at University of Montpellier: ${course.duration}, €${course.annualEUR.toLocaleString()}/EUR/yr. IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas.`,
