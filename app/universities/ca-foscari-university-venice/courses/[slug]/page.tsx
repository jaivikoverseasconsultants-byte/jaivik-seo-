...
export async function generateMetadata(
  ...
  return buildMetadata({
    title: `${course.name} at Ca' Foscari University of Venice 2026 – Fees, IELTS & Requirements`,
    description: `${course.name} at Ca' Foscari University of Venice: ${course.duration}, €${course.annualEUR.toLocaleString()}/yr. IELTS ${course.ieltsMin}+. Intake: ${course.intakeMonths.join(' & ')}. Free guidance from Jaivik Overseas.`,
