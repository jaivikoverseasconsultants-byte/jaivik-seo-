...
export default function ExitIntentPopup() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setSubmitted(true);
    sessionStorage.setItem('exitPopupDismissed', '1');
    const countryPart = country ? ` I want to study in ${country}.` : '';
    const msg = encodeURIComponent(`Hi Jaivik Overseas! I'm ${name} (${phone}).${countryPart} Please send me a free university shortlist.`);
    setTimeout(() => {
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="bg-gradient-to-r from-brand-700 to-brand-900 px-6 pt-6 pb-8 text-white text-center relative">
          ...
          <h2 className="text-xl font-bold mb-1">Wait! Get Free University Shortlist</h2>
          <p className="text-blue-100 text-sm">Our counsellors will shortlist <span className="text-gold-400 font-semibold">matching universities</span> for you — completely free</p>
        </div>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                >
                  ...
                  {['Canada', 'UK', 'Australia', 'Germany', 'USA', 'Ireland', 'Singapore', 'New Zealand'].map(c => (
                ...
                >
                  ...
                  Get Free Shortlist on WhatsApp
                </button>
              </form>
